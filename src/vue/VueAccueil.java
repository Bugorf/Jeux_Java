...
public class VueAccueil extends JFrame {
    ...
    public void switchView(VueAccueil vueAccueil) {
        cardLayout.show(cardPanel, "panelAccueil");
    }

    public void switchView(VueParam vueParam) {
        cardLayout.show(cardPanel, "panelParam");
    }

    public void switchView(VueInterm vueInterm) {
        cardLayout.show(cardPanel, "vueInterm");
    }
}
